...
public class SqlMapDocumentOverrider extends AbstractXmlPluginAdaptor {

    protected Document document;

    public SqlMapDocumentOverrider(Document document,
            IntrospectedTable introspectedTable,
            ChangeGeneratedXmlForAdayoSrmPlugin changeGeneratedXmlForAdayoSrmPlugin) {

        super(document.getRootElement(), introspectedTable, changeGeneratedXmlForAdayoSrmPlugin);
